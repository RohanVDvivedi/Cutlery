...
int merge_sort_ ## container(container* c, cy_uint start_index, cy_uint last_index, int (*compare)(const contained_type* data1, const contained_type* data2), memory_allocator mem_allocator);\
int heap_sort_ ## container(container* c, cy_uint start_index, cy_uint last_index, int (*compare)(const contained_type* data1, const contained_type* data2));\
